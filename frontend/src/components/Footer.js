    ...
    <div className=" bg-neutral-300 dark:bg-neutral-800 dark:text-white ">
      <div className=" flex flex-col md:flex-row px-3 md:space-x-2 py-5  m-auto   md:max-w-2xl | lg:max-w-4xl | xl:max-w-6xl ">
        <div className="my-5 mx-2 flex-1 md:pr-16 ">
          ...
          <p className="pl-1 opacity-70">
            Lorem ipsum dolor sit amet consectetur adipis icing elit. Quia,
            molestias?
          </p>
        </div>
        ...
        <div className="my-5 mx-2 flex-1 space-y-3">
          ...
          <p className="pl-1">
            ...
            <a
              className="opacity-70 hover:opacity-100 text-sm"
              href="mailto:sameerlink123@gmail.com"
            >
              sameerlink123@gmail.com
            </a>{" "}
          </p>
          <div className=" pl-1 flex space-x-4">
            <a
              href="https://www.linkedin.com/in/sameersoni97/"
              target="_blank"
              rel="noreferrer"
            >
              <img
                className="dark:invert opacity-80 hover:opacity-100 "
                alt="Linkedin"
                src={linkedinSvg}
              />
            </a>
            <a
              href="https://github.com/SoniSameer"
              target="_blank"
              rel="noreferrer"
            >
              <img
