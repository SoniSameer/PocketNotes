...
const Login = () => {
  const host = "https://pocket-notes-sameer.herokuapp.com";
  ...
  return (
    <div className="bg-neutral-200 min-h-screen flex justify-center md:items-center py-14 px-2  dark:bg-black">
      ...
      >
        <h1 className="  |  mb-6 text-2xl | sm:text-3xl  |  md:text-3xl font-bold text-center">
          Login to Pocket Notes
        </h1>
        <form onSubmit={onSubmit}>
          ...
          <div className="  flex flex-col mb-5">
            ...
            <p className="mt-3 px-1 text-sm opacity-70 ">
              <span className="text-red-500 text-base"> Warning</span> : Please
